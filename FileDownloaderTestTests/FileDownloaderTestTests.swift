...
class FileDownloaderTestTests: XCTestCase {
    ...
    func test0SimpleDownload() {
        ...
        self.wait(for: [resumeExpectation], timeout: 100000)
        sleep(30000)
    ...
    func test2PauseDownload() {
        ...
        self.wait(for: [resumeExpectation], timeout: 10000)
        sleep(10)
        ...
        self.wait(for: [pauseExpectation], timeout: 100)
    ...
    func test4PauseInvalidDownload() {
        ...
        self.wait(for: [pauseExpectation], timeout: 10000)
    ...
    func test5RemoveInvalidDownload() {
        ...
        //To be able to pass allDownloads in this test function we first should call resuma and pause on some task (Othervise in allDownloads I will not have downloads with self.identifier)
        let resumeExpectation = self.expectation(description: "resumeExpectation")
    ...
    func test6DownloadFiles() {
        ...
        //Added by me
        //We should add small delay for our tasks to complete, otherwise their state will be DOWNLOADING and test will fail
        //You can see downloading process in logs
        sleep(100000)
